...
function(qface_add_aggregator_library LIB_NAME FILE_LIST_)
    ...
    add_library(${LIB_NAME} ${AGGREGATED_FILE_LIST})
...
function(add_qface_package LIBRARY_NAME INTERFACE_FOLDER)
    ...
    target_link_libraries(${LIBRARY_NAME}_api QmlCppAPILib)
    ...
    target_link_libraries(${LIBRARY_NAME}_dummy ${LIBRARY_NAME}_api)
