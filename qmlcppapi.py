...
def run_generation(input, output):
    ...
    for module in system.modules:
        ...
        generator.write('api/{{path}}/{{module|upperfirst}}Module.h', 'Module.template.h', ctx)
        generator.write('api/{{path}}/{{module|upperfirst}}Module.cpp', 'Module.template.cpp', ctx)
        generator.write('ipc/{{path}}/{{module|upperfirst}}ModuleIPC.h', 'ModuleIPC.template.h', ctx)
        generator.write('dummy/{{path}}/{{module|upperfirst}}ModuleDummy.h', 'DummyModule.template.h', ctx)
